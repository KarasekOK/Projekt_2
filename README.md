...
#### Po uživately je žádáno aby zadal čísla od 1 do 4 pokud zadá jiné čísla než je žádáno program se ho zeptá znova dokud nedá zprávný (dály však písmeno program ohlásí chybu protože float příjmá poze čísla neboli jejich hodnoty a musí se program restartovat).
